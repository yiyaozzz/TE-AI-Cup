...
def main(pdf_path, header_dir, table_dir, output_text_path, first_image_crop_lines, rest_image_crop_line):
    ...
    process_and_crop_pdf(pdf_path, header_dir, table_dir, first_image_crop_lines, rest_image_crop_line)
...
if __name__ == "__main__":
    pdf_path = "data/Production Sheet/500000285217.pdf"
    ...
    main(pdf_path, header_dir, table_dir, output_text_path, first_image_crop_lines, rest_image_crop_line)