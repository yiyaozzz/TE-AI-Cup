...
import numpy as np
import os
from main.barcode_det import erase_barcodes_from_image
...
def process_input_file(file, pathval):
    fileID = pathval
    """
    ...
    base_folder = f"./tempTables_{fileID}"
...
def take_input(image, pathval="/"):
    ...
    """
    process_input_file(image, pathval)
    print("Executed")
