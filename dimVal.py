import cv2
import numpy as np
from nextjs.works.main.api import aapiResult
import time
import os
from nextjs.works.main.gapi import apiResult
...
#     "nextjs/works/finalOutput_b828b7a5-50e5-4f16-92f3-511703cdb07f.pdf/page_14/row_2/column_4/18_Words.png")
# print(result)
# delete_cropped_images('temp_cropped_images')
